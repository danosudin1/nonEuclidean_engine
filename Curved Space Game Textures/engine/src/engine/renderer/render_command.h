...
namespace engine
{
    ...
    public:
		...
		static void submit_lines(const ref<vertex_array>& vertex_array)
		{
			renderer_api::draw_indexed_lines(vertex_array);
		}

		static void submit_patches_two(const ref<vertex_array>& vertex_array)
		{
			renderer_api::draw_indexed_patches_two(vertex_array);
		}

		static void submit_patches(const ref<vertex_array>& vertex_array)
		{
			renderer_api::draw_indexed_patches(vertex_array);
		}
