...
namespace engine
{
    ...
    public:
		...
		/// \brief Returns a reference to the layer_stack.
		layers_stack& layers() { return m_layers_stack; }

		/// \brief Returns a reference to a specific layer.
		layer* layer_at(int i) { return m_layers_stack.layer_at(i); }
