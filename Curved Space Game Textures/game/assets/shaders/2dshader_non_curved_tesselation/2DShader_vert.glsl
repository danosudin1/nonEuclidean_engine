...
void main()  
{
	...
	cs_position = toCartesian(a_position.x, constrain_angle_rad(a_position.y + in_object_rotation + in_object_position.y + m_pi)) + toCartesian(in_object_position.x, in_object_position.y);
}
